...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_dota_5fshared_5fenums_2eproto 
...
enum EDPCPushNotification {
  ...
  DPC_PUSH_NOTIFICATION_TEAM_ROSTER_CHANGE = 20,
  DPC_PUSH_NOTIFICATION_TEAM_RESULT = 21,
  DPC_PUSH_NOTIFICATION_PREDICTION_MATCHES_AVAILABLE = 30,
  DPC_PUSH_NOTIFICATION_PREDICTION_MATCH_COMPLETED = 31,
  DPC_PUSH_NOTIFICATION_FANTASY_ROSTER_REMINDER = 40,
  DPC_PUSH_NOTIFICATION_FANTASY_PLAYER_CLEARED = 41,
  DPC_PUSH_NOTIFICATION_FANTASY_DAILY_SUMMARY = 42,
  DPC_PUSH_NOTIFICATION_FANTASY_FINAL_RESULTS = 43
};
...
class CDOTAClientHardwareSpecs : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CDOTAClientHardwareSpecs) */ {
 public:
  ...
  inline CDOTAClientHardwareSpecs* New() const final {
    return CreateMaybeMessage<CDOTAClientHardwareSpecs>(NULL);
  }
...
class CDOTASaveGame_Player : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CDOTASaveGame.Player) */ {
 public:
  ...
  inline CDOTASaveGame_Player* New() const final {
    return CreateMaybeMessage<CDOTASaveGame_Player>(NULL);
  }
...
class CDOTASaveGame_SaveInstance_PlayerPositions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CDOTASaveGame.SaveInstance.PlayerPositions) */ {
 public:
  ...
  inline CDOTASaveGame_SaveInstance_PlayerPositions* New() const final {
    return CreateMaybeMessage<CDOTASaveGame_SaveInstance_PlayerPositions>(NULL);
  }
...
class CDOTASaveGame_SaveInstance : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CDOTASaveGame.SaveInstance) */ {
 public:
  ...
  inline CDOTASaveGame_SaveInstance* New() const final {
    return CreateMaybeMessage<CDOTASaveGame_SaveInstance>(NULL);
  }
...
class CDOTASaveGame : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CDOTASaveGame) */ {
 public:
  CDOTASaveGame();
  ...
  inline CDOTASaveGame* New() const final {
    return CreateMaybeMessage<CDOTASaveGame>(NULL);
  }
...
class CMsgDOTACombatLogEntry : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CMsgDOTACombatLogEntry) */ {
 public:
  ...
  inline CMsgDOTACombatLogEntry* New() const final {
    return CreateMaybeMessage<CMsgDOTACombatLogEntry>(NULL);
  }
 ...
 private:
  ...
  void set_has_target_source_name();
  void clear_has_target_source_name();
  void set_has_attacker_name();
  void clear_has_attacker_name();
  void set_has_damage_source_name();
  void clear_has_damage_source_name();
  void set_has_inflictor_name();
  void clear_has_inflictor_name();
  void set_has_is_attacker_illusion();
  void clear_has_is_attacker_illusion();
  void set_has_is_attacker_hero();
  void clear_has_is_attacker_hero();
  void set_has_is_target_illusion();
  void clear_has_is_target_illusion();
  void set_has_is_target_hero();
  void clear_has_is_target_hero();
  void set_has_is_visible_radiant();
  void clear_has_is_visible_radiant();
  void set_has_is_visible_dire();
  void clear_has_is_visible_dire();
  void set_has_value();
  ...
  void set_has_slow_duration();
  void clear_has_slow_duration();
  void set_has_is_ability_toggle_on();
  void clear_has_is_ability_toggle_on();
  void set_has_is_ability_toggle_off();
  void clear_has_is_ability_toggle_off();
  ...
  void set_has_gold_reason();
  void clear_has_gold_reason();
  void set_has_timestamp_raw();
  void clear_has_timestamp_raw();
  void set_has_modifier_duration();
  void clear_has_modifier_duration();
  void set_has_xp_reason();
  void clear_has_xp_reason();
  void set_has_last_hits();
  void clear_has_last_hits();
  void set_has_attacker_team();
  void clear_has_attacker_team();
  void set_has_target_team();
  void clear_has_target_team();
  void set_has_obs_wards_placed();
  void clear_has_obs_wards_placed();
  void set_has_assist_player0();
  void clear_has_assist_player0();
  void set_has_assist_player1();
  void clear_has_assist_player1();
  void set_has_assist_player2();
  void clear_has_assist_player2();
  void set_has_assist_player3();
  void clear_has_assist_player3();
  void set_has_stack_count();
  void clear_has_stack_count();
  void set_has_hidden_modifier();
  void clear_has_hidden_modifier();
  void set_has_is_target_building();
  void clear_has_is_target_building();
  void set_has_neutral_camp_type();
  void clear_has_neutral_camp_type();
  void set_has_rune_type();
  void clear_has_rune_type();
  void set_has_is_heal_save();
  void clear_has_is_heal_save();
  void set_has_is_ultimate_ability();
  void clear_has_is_ultimate_ability();
  void set_has_attacker_hero_level();
  void clear_has_attacker_hero_level();
  void set_has_target_hero_level();
  void clear_has_target_hero_level();
  void set_has_xpm();
  void clear_has_xpm();
  void set_has_gpm();
  void clear_has_gpm();
  void set_has_event_location();
  void clear_has_event_location();
  void set_has_target_is_self();
  void clear_has_target_is_self();
  void set_has_damage_type();
  void clear_has_damage_type();
  void set_has_invisibility_modifier();
  void clear_has_invisibility_modifier();
  void set_has_damage_category();
  void clear_has_damage_category();
  void set_has_networth();
  void clear_has_networth();
  void set_has_building_type();
  void clear_has_building_type();
  void set_has_modifier_elapsed_duration();
  void clear_has_modifier_elapsed_duration();
  void set_has_silence_modifier();
  void clear_has_silence_modifier();
  void set_has_heal_from_lifesteal();
  void clear_has_heal_from_lifesteal();
  void set_has_modifier_purged();
  void clear_has_modifier_purged();
  void set_has_spell_evaded();
  void clear_has_spell_evaded();
  void set_has_motion_controller_modifier();
  void clear_has_motion_controller_modifier();
  void set_has_long_range_kill();
  void clear_has_long_range_kill();
  void set_has_modifier_purge_ability();
  void clear_has_modifier_purge_ability();
  void set_has_modifier_purge_npc();
  void clear_has_modifier_purge_npc();
  void set_has_root_modifier();
  void clear_has_root_modifier();
  void set_has_total_unit_death_count();
  void clear_has_total_unit_death_count();
  void set_has_aura_modifier();
  void clear_has_aura_modifier();
  void set_has_armor_debuff_modifier();
  void clear_has_armor_debuff_modifier();
  void set_has_no_physical_damage_modifier();
  void clear_has_no_physical_damage_modifier();
  void set_has_modifier_ability();
  void clear_has_modifier_ability();
  void set_has_modifier_hidden();
  void clear_has_modifier_hidden();
  void set_has_inflictor_is_stolen_ability();
  void clear_has_inflictor_is_stolen_ability();
  void set_has_kill_eater_event();
  void clear_has_kill_eater_event();
  void set_has_unit_status_label();
  void clear_has_unit_status_label();
...
inline void CMsgDOTACombatLogEntry::set_has_root_modifier() {
  _has_bits_[1] |= 0x20000000u;
}
inline void CMsgDOTACombatLogEntry::clear_has_root_modifier() {
  _has_bits_[1] &= ~0x20000000u;
}
...
inline void CMsgDOTACombatLogEntry::set_has_total_unit_death_count() {
  _has_bits_[1] |= 0x10000000u;
}
inline void CMsgDOTACombatLogEntry::clear_has_total_unit_death_count() {
  _has_bits_[1] &= ~0x10000000u;
}
...
inline void CMsgDOTACombatLogEntry::set_has_aura_modifier() {
  _has_bits_[1] |= 0x40000000u;
}
inline void CMsgDOTACombatLogEntry::clear_has_aura_modifier() {
  _has_bits_[1] &= ~0x40000000u;
}
...
inline void CMsgDOTACombatLogEntry::set_has_armor_debuff_modifier() {
  _has_bits_[1] |= 0x80000000u;
}
inline void CMsgDOTACombatLogEntry::clear_has_armor_debuff_modifier() {
  _has_bits_[1] &= ~0x80000000u;
}
...
inline void CMsgDOTACombatLogEntry::set_has_no_physical_damage_modifier() {
  _has_bits_[2] |= 0x00000001u;
}
inline void CMsgDOTACombatLogEntry::clear_has_no_physical_damage_modifier() {
  _has_bits_[2] &= ~0x00000001u;
}
...
inline void CMsgDOTACombatLogEntry::set_has_modifier_ability() {
  _has_bits_[2] |= 0x00000002u;
}
inline void CMsgDOTACombatLogEntry::clear_has_modifier_ability() {
  _has_bits_[2] &= ~0x00000002u;
}
inline void CMsgDOTACombatLogEntry::clear_modifier_ability() {
  modifier_ability_ = 0u;
  clear_has_modifier_ability();
}
...
inline void CMsgDOTACombatLogEntry::set_has_modifier_hidden() {
  _has_bits_[2] |= 0x00000004u;
}
inline void CMsgDOTACombatLogEntry::clear_has_modifier_hidden() {
  _has_bits_[2] &= ~0x00000004u;
}
inline void CMsgDOTACombatLogEntry::clear_modifier_hidden() {
  modifier_hidden_ = false;
  clear_has_modifier_hidden();
}
...
inline void CMsgDOTACombatLogEntry::set_has_inflictor_is_stolen_ability() {
  _has_bits_[2] |= 0x00000008u;
}
inline void CMsgDOTACombatLogEntry::clear_has_inflictor_is_stolen_ability() {
  _has_bits_[2] &= ~0x00000008u;
}
inline void CMsgDOTACombatLogEntry::clear_inflictor_is_stolen_ability() {
  inflictor_is_stolen_ability_ = false;
  clear_has_inflictor_is_stolen_ability();
}
...
inline void CMsgDOTACombatLogEntry::set_has_kill_eater_event() {
  _has_bits_[2] |= 0x00000010u;
}
inline void CMsgDOTACombatLogEntry::clear_has_kill_eater_event() {
  _has_bits_[2] &= ~0x00000010u;
}
inline void CMsgDOTACombatLogEntry::clear_kill_eater_event() {
  kill_eater_event_ = 0u;
  clear_has_kill_eater_event();
}
...
inline void CMsgDOTACombatLogEntry::set_has_unit_status_label() {
  _has_bits_[2] |= 0x00000020u;
}
inline void CMsgDOTACombatLogEntry::clear_has_unit_status_label() {
  _has_bits_[2] &= ~0x00000020u;
}
inline void CMsgDOTACombatLogEntry::clear_unit_status_label() {
  unit_status_label_ = 0u;
  clear_has_unit_status_label();
}
...
template <> struct is_proto_enum< ::DOTA_LobbyMemberXPBonus> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::ELeagueFantasyPhase> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ELeagueFantasyPhase>() {
  return ::ELeagueFantasyPhase_descriptor();
}
