...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_dota_5fcommonmessages_2eproto 
...
class CDOTAMsg_LocationPing : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CDOTAMsg_LocationPing) */ {
 public:
  ...
  inline CDOTAMsg_LocationPing* New() const final {
    return CreateMaybeMessage<CDOTAMsg_LocationPing>(NULL);
  }
...
class CDOTAMsg_ItemAlert : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CDOTAMsg_ItemAlert) */ {
 public:
  CDOTAMsg_ItemAlert();
  ...
  inline CDOTAMsg_ItemAlert* New() const final {
    return CreateMaybeMessage<CDOTAMsg_ItemAlert>(NULL);
  }
...
class CDOTAMsg_MapLine : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CDOTAMsg_MapLine) */ {
 public:
  CDOTAMsg_MapLine();
  ...
  inline CDOTAMsg_MapLine* New() const final {
    return CreateMaybeMessage<CDOTAMsg_MapLine>(NULL);
  }
...
class CDOTAMsg_WorldLine : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CDOTAMsg_WorldLine) */ {
 public:
  CDOTAMsg_WorldLine();
  ...
  inline CDOTAMsg_WorldLine* New() const final {
    return CreateMaybeMessage<CDOTAMsg_WorldLine>(NULL);
  }
...
class CDOTAMsg_SendStatPopup : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CDOTAMsg_SendStatPopup) */ {
 public:
  ...
  inline CDOTAMsg_SendStatPopup* New() const final {
    return CreateMaybeMessage<CDOTAMsg_SendStatPopup>(NULL);
  }
...
class CDOTAMsg_DismissAllStatPopups : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CDOTAMsg_DismissAllStatPopups) */ {
 public:
  ...
  inline CDOTAMsg_DismissAllStatPopups* New() const final {
    return CreateMaybeMessage<CDOTAMsg_DismissAllStatPopups>(NULL);
  }
...
class CDOTAMsg_UnitOrder : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CDOTAMsg_UnitOrder) */ {
 public:
  CDOTAMsg_UnitOrder();
  ...
  inline CDOTAMsg_UnitOrder* New() const final {
    return CreateMaybeMessage<CDOTAMsg_UnitOrder>(NULL);
  }
...
inline void CDOTAMsg_ItemAlert::set_has_item_ability_id() {
  _has_bits_[0] |= 0x00000004u;
}
inline void CDOTAMsg_ItemAlert::clear_has_item_ability_id() {
  _has_bits_[0] &= ~0x00000004u;
}
