...
class CDemoSyncTick :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CDemoSyncTick) */ {
 public:
  CDemoSyncTick();
...
class CDemoStop :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CDemoStop) */ {
 public:
  CDemoStop();
  virtual ~CDemoStop();
