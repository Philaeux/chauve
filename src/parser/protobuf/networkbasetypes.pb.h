...
class CSVCMsgList_UserMessages_usermsg_t :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CSVCMsgList_UserMessages.usermsg_t) */ {
 public:
...
class CSVCMsgList_UserMessages :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:CSVCMsgList_UserMessages) */ {
 public:
