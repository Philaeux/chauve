...
public:
  ...
  inline std::string GetTagName() const { return tag_name_; };
...
private:
  ...
  Hero(uint32_t id, std::string code_name, std::string formated_name, std::string tag_name);
